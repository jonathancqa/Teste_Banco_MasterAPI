...
using BancoAPI.Src.Repository.Implements;
...
namespace BancoAPI
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<BancoContexto>(options => options.UseSqlServer(Configuration["ConnectionStringsDev:DefaultConnection"]));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, BancoContexto contexto)
        {
